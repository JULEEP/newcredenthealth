      ...
      <div className="container">
        <div className="row gy-4">
          ...
          <div className="col-12 col-lg-4">
            ...
            <p className="mb-3">
              Your complete healthcare solution for consultations, diagnostics,
          ...
          <div className="col-6 col-md-4 col-lg-2">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a href="/family" className="text-light text-decoration-none">
                  Family Members
                </a>
              </li>
            </ul>
          ...
          <div className="col-6 col-md-4 col-lg-3">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a href="/wallet" className="text-light text-decoration-none">
                  Wallet
                </a>
              </li>
              <li>
          ...
          <div className="col-12 col-md-4 col-lg-3">
            ...
            <ul className="list-unstyled">
              <li className="d-flex align-items-center mb-2">
                <FaMapMarkerAlt className="me-2" /> GROUND FLOOR BEECH E-1,
                MANYATA EMBASSY BUSINESS, Venkateshapura, Bangalore North,
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
          ...
          <div className="d-flex gap-3">
            <a href="/privacyandpolicy" className="text-light text-decoration-none">
              Privacy Policy
            </a>
            <a
